...
`01_Roadmap_System_Design.md` определяет порядок проектирования цифровой системы до проектирования архитектуры системы, формирования технических требований, выбора инструментария и реализации.
...
### 7.2. Шаг 2. Определить [[Entities|сущности]]
...
### 7.3. Шаг 3. Определить [[Data|данные]]
...
### 7.4. Шаг 4. Определить [[Rules|правила]]
...
### 7.5. Шаг 5. Определить [[States|состояния]]
...
### 7.6. Шаг 6. Определить [[Events|события]]
...
### 7.7. Шаг 7. Определить [[Flows|потоки]]
...
### 7.8. Шаг 8. Определить [[Storage|хранение]]
...
### 7.9. Шаг 9. Определить [[Errors|ошибки]]
...
- входные данные для [[docs/03_roadmaps/02_Roadmap_System_Architecture_Design|Roadmap: System Architecture Design]].
