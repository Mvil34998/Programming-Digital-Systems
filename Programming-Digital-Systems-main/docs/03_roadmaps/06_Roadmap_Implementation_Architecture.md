...
`06_Roadmap_Implementation_Architecture.md` определяет порядок проектирования архитектуры реализации цифровой системы.
...
- входные данные для кодирования и [[docs/03_roadmaps/07_Roadmap_Testing|Roadmap: Testing]].
