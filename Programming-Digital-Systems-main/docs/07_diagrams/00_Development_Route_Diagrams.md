...
flowchart TD
    ...
    class A root
    class B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q type
```
...
flowchart TD
    ...
    class A root
    class B,C,D,E,A1,B1,C1,D1 type
```
...
flowchart TD
    ...
    class A root
    class B,D,E,F,G,H,I,J,K,L type
```
...
flowchart TD
    ...
    class A root
    class B,C,D,E,F,G,H,I,J,K,L,M,N type
```
