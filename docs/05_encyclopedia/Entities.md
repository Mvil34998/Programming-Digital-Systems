...
- список сущностей может быть использован в `docs/05_encyclopedia/Data.md` и `docs/03_roadmaps/01_01_01_Roadmap_System_Design.md`.
...
- `docs/00_maps/00_00_00_Knowledge_Layer_Map.md`
