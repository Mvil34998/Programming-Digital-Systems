...
Связь требований с выбором инструментария должна проходить через отдельную карту перехода: [[docs/00_maps/Requirements_To_Toolchain_Map|Requirements To Toolchain Map]].
...
- этапы не противоречат [[docs/00_maps/Documentation_Map|Documentation Map]];
