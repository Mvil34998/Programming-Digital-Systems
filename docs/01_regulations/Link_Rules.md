...
```md
[[docs/03_roadmaps/03_03_Roadmap_Technical_Requirements#7.1. Требования к данным|Требования к данным]]
```
...
```md
[Roadmap: System Design](../03_roadmaps/01_01_Roadmap_System_Design.md)
```
...
```md
- [[docs/03_roadmaps/01_01_Roadmap_System_Design|Roadmap: System Design]]
  - GitHub: [Roadmap: System Design](../03_roadmaps/01_01_Roadmap_System_Design.md)
