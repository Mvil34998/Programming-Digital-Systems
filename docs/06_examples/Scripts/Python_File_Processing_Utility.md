...
Это важно для связи с [[docs/03_roadmaps/Toolchain_Selection_Category_Rules|Toolchain Selection Category Rules]]: специализированные категории инструментария не выбираются, если они не требуются типом системы.
