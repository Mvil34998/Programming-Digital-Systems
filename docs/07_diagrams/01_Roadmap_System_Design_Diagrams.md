...
`Roadmap_System_Design_Diagrams.md` хранит диаграммы этапа проектирования системы.
...
Документ не заменяет [[docs/03_roadmaps/Roadmap_System_Design|Roadmap: System Design]] и [[docs/04_questionnaires/Questionnaire_System_Design|Questionnaire: System Design]].
