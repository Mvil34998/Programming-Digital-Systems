...
- формирования технических требований;
...
- директории по слоям;
- директории по функциям;
- директории по доменным областям;
- смешанная структура с явными правилами зависимостей.
...
- как создаётся поставочный артефакт;
- как выполняется установка;
- как выполняется обновление;
- какие команды должны быть документированы.

### 7.10. Правила зависимостей реализации

Необходимо определить:

- какие модули могут импортировать другие модули;
- какие зависимости запрещены;
- где допустимы зависимости от внешних библиотек;
- где запрещены инфраструктурные зависимости;
- как предотвращаются циклические зависимости.
...
## 11. Шаблон описания структуры проекта
...
## 12. Шаблон описания модуля реализации
