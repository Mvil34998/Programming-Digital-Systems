...
Связанный roadmap: [[docs/03_roadmaps/Roadmap_Toolchain_Selection|Roadmap: Toolchain Selection]].

Связанная анкета: [[docs/04_questionnaires/Questionnaire_Toolchain_Selection|Questionnaire: Toolchain Selection]].
...
В [[docs/03_roadmaps/Roadmap_Toolchain_Selection|Roadmap: Toolchain Selection]] должно быть правило:
