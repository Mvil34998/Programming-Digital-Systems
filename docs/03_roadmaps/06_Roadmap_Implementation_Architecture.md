...
`06_06_Roadmap_Implementation_Architecture.md` определяет порядок проектирования архитектуры реализации цифровой системы.
...
- [[docs/07_diagrams/06_06_Roadmap_Implementation_Architecture_Diagrams|Roadmap Implementation Architecture Diagrams]]
  - Передаёт: полный визуальный набор диаграмм архитектуры реализации.
...
- входные данные для кодирования и [[docs/03_roadmaps/07_07_Roadmap_Testing|Roadmap: Testing]].
