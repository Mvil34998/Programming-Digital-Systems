...
`05_05_Toolchain_Selection_Category_Rules.md` определяет правила категоризации инструментария при выборе средств реализации цифровой системы.
...
Связанный roadmap: [[docs/03_roadmaps/05_05_Roadmap_Toolchain_Selection|Roadmap: Toolchain Selection]].

Связанная анкета: [[docs/04_questionnaires/05_05_Questionnaire_Toolchain_Selection|Questionnaire: Toolchain Selection]].
...
В [[docs/03_roadmaps/05_05_Roadmap_Toolchain_Selection|Roadmap: Toolchain Selection]] должно быть правило:
