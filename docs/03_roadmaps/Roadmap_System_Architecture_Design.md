...
Документ используется после [[docs/03_roadmaps/Roadmap_System_Design|Roadmap: System Design]] и до [[docs/03_roadmaps/Roadmap_Technical_Requirements|Roadmap: Technical Requirements]].
...
Точка расширения должна быть связана с требованиями, ожидаемым развитием или [[docs/03_roadmaps/Roadmap_System_Evolution|Roadmap: System Evolution]].
