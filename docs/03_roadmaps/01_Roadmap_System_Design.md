...
`01_01_Roadmap_System_Design.md` определяет порядок проектирования цифровой системы до проектирования архитектуры системы, формирования технических требований, выбора инструментария и реализации.
...
- входные данные для [[docs/03_roadmaps/02_02_Roadmap_System_Architecture_Design|Roadmap: System Architecture Design]].
